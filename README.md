...
# Order-based message
docker exec redis-master redis-cli XADD status-stream "*" payload '{"orderId":"ORDER123","distributor_id":"DIST001","sourceservice":"order-service","status":"PROCESSING"}'

# MQID-based message
docker exec redis-master redis-cli XADD status-stream "*" payload '{"mqid":"MQ123","orderId":"ORDER1234","firm_id":"DIST001","sourceservice":"some-service","status":"COMPLETED"}'
```
